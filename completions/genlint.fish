...
function __fish_genlint_global_optspecs
	string join \n s/stdin i/input= e/exclude= f/format= o/output= d/disable= a/text l/max-line-length= c/max-consecutive-blank= max-errors= max-warnings= h/help V/version
end
...
complete -c genlint -n "__fish_genlint_needs_command" -l max-errors -d 'Maximum number of errors to report (set to 0 to disable)' -r
complete -c genlint -n "__fish_genlint_needs_command" -l max-warnings -d 'Maximum number of warnings to report (set to 0 to disable)' -r
